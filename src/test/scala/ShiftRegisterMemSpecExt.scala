...
// class ShiftRegisterMemExtSpec extends FlatSpec with Matchers {
...
//         "--backend-name", "verilator"),() => new SRMemModule(dut)) {
//       c => new SRMemTester(c, testVector, expected)
//     }  should be (true)
//
//   it should "work with single-ported memories, an enable, and an odd shift" ignore {
...
//   }
//
//   it should "work with single-ported memories, no enable, and an odd shift" ignore {
...
//   }
//
//   it should "work with single-ported memories, no enable, and an even shift" ignore {
...
//   }
//
//   it should "work with dual-ported memories, an enable, and an odd shift" ignore {
...
//   }
//
//   it should "work with dual-ported memories, an enable, and an even shift" ignore {
...
//   }
//
//   it should "work with dual-ported memories, no enable, and an odd shift" ignore {
...
//   }
//
//   it should "work with dual-ported memories, no enable, and an even shift" ignore {
...
//   }
//
//   it should "work with delay 0" ignore {
...
//   }
//
//   it should "work with delay 1, and no enable" ignore {
...
//     )
//   }
//   it should "work with delay 1, and an enable" ignore {
